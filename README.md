...
def CreatAccount():
         ...
         def CreaAcc():
                           ...
                           x1t=str(x1.get())
                           x2t=str(x2.get())
                           my=mysql.connector.connect(host="localhost",user="root",passwd="aman1983",database="py")
                           mycursor=my.cursor()
 ...
 def CandidateLogin():
         ...
         def Opener():
                  ...
                  myc=mysql.connector.connect(host="localhost",user="root",passwd="aman1983",database="py")
                  myr=myc.cursor()
...
def Rechagres():
         ...
         rechr.attributes('-fullscreen',True)
                                    ...
                                    def Feeder():
                                             try:
                                                      ...
                                                      if(x321==n1):
                                                               ...
                                                               login15.configure(text='INCORRECT OTP!! PLEASE TRY AGAIN!!!',fg="red")
                                                                   
                                                               

                                             except ValueError:
                                                      login15.configure(text="PLEASE ENTER A VALID OTP!!!",fg="red")
                  ...
                  #Check wether the number of turns is more than zero or not. if it is?
                           ...
                           if(n>0):
                                    ...
                                    if(str(cur)==str(exy)):
                                             ...
                                             ig=tkinter.PhotoImage(master=mac,file=r"C:/Users/Best Buy/Downloads/Smiling_Face_Emoji_large.png")
                           ...
                           if(n==0):
                                    ...
                                    mac=tkinter.Canvas(mw,height=250,width=250)
                                    mac.place(x=683,y=384)
                                    ig=tkinter.PhotoImage(master=mac,file=r"C:/Users/Best Buy/Downloads/Very_sad_emoji_icon_png_grande.png")
                           ...
                           try:
                                    ...
                                    if(turn>1 and myn>=1000):
                                             if(myn==correct):
                                                      ...
                                                      imog=tkinter.PhotoImage(master=raj,file=r"C:/Users/Best Buy/Downloads/Smiling_Face_Emoji_large.png")
                                             ...
                                             if(myn==correct):
                                                      ...
                                                      raj=tkinter.Label(b,bg='#a6f514')
                                                      raj.place(x=400,y=306)
                                                      imog=tkinter.PhotoImage(master=raj,file=r"C:/Users/Best Buy/Downloads/Very_sad_emoji_icon_png_grande.png")
                                                      cap=imog.subsample(2,2)
                                                      b.cap=cap
                                                      raj.configure(image=cap)
                                                      su.place_forget()
